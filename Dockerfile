...
RUN apt-get update -qqy \
  ...
  libxss-dev libxrandr-dev libxcb-dri3-0 libgbm1 libasound2-dev libatk1.0-dev libgtk-3-dev ttf-ancient-fonts \
  chromium-codecs-ffmpeg-extra libappindicator3-1 \
